...
This repository tracks notable **SaaS platforms** and **open-source projects** for **Tax Collection**. These tools help local governments, municipalities, and public agencies bill, collect, and manage property taxes, utility bills, assessments, and other revenue streams, often with online payment portals and cashiering functions.

**Examples** include Tyler Tax Billing, ACI Speedpay, Point & Pay, InvoiceCloud, Harris Tax, Springbrook, Edmunds GovTech, BS&A Tax, Grant Street Group, and TaxSys (the category leaders).

**Open-source emphasis**: This section is heavily expanded with available projects. Mature, production-grade open-source alternatives specifically for U.S. municipal property tax billing and collection remain very limited. Most open-source work focuses on individual income tax engines, general billing systems, or country-specific tax administration tools that can serve as partial building blocks.
...
|---|---|---|---|---|
| **[Tyler Tax Billing / Tyler Technologies](https://www.tylertech.com/)** | Leading government software suite offering property tax billing. | $1.9B Revenue | Custom Quote (Based on jurisdiction size/modules) | No Free Tier (Enterprise Only) |
| **[InvoiceCloud](https://www.invoicecloud.com/)** | Digital billing and payment platform that helps municipalities. | $1B+ Valuation | Custom Pricing (Transaction-fee based model) | No Free Tier (Enterprise Only) |
| **[ACI Speedpay](https://www.acispeedpay.com/)** | Electronic bill presentment and payment platform. | $1B+ Valuation | Custom Pricing (Per transaction fees) | No Free Tier (Enterprise Only) |
| **[Harris Tax](https://www.harriscomputer.com/)** | Additional specialized platforms covering property tax administration. | $500M+ Revenue | Custom Quote (Per module/license) | No Free Tier (Enterprise Only) |
| **[Point & Pay](https://www.pointandpay.com/)** | Payment processing and cashiering solutions for local governments. | $50M+ Revenue | Custom Pricing (Convenience fee model) | No Free Tier (Enterprise Only) |
...
- Data analysis and open finance tools for transparency around collected revenues.
- Many academic or one-off municipal systems that are partially released as open source.
...
- Always involve legal, finance, and IT stakeholders, and verify compliance with local tax codes, data privacy laws, and payment regulations before deployment.
